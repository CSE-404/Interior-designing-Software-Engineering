...
-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('css/style.css') }}"></head>
<body>
<div id="div1">
        <div id="div2">
            <div id= "nav_wrapper">
 ...
 <h2 style="text-align:left;color: white"><b>Our Latest News-</h2></b>
  <ul style="list-style-type:circle;text-align:left;color: white">
  <li>1. We are happily to inform you recently three designers join in our firm.</li>
  <li>2. We recently added office interior design in our service.</li>
  <li>3. We provide raw materials supply system from our dealer in a cheap rate. Now you can place order in our website using login system.</li>
  <li>4. We also provide designers for your service. Now you can choose designer from our website using login system.</li>
</ul> 
<div id="wrapper">
